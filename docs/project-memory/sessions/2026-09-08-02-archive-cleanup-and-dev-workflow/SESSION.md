...
Added:    scripts/dev.py
          docs/project-memory/sessions/2026-09-08-02-.../{SESSION,PROMPTS,REPORT}.md
...
Modified: AGENTS.md CLAUDE.md GEMINI.md QWEN.md README.md CONTRIBUTING.md
          ...
          docs/project-memory/{DECISIONS,RESEARCH,MEMORY_INDEX,
            DISCUSSION_SUMMARY,AI_AGENT_PROTOCOL,SESSION_LOG}.md
          docs/project-memory/sessions/2026-09-08-01-.../PROMPTS.md
          scripts/session.py
