...
docs/project-memory/MEMORY_INDEX.md
docs/project-memory/PROJECT_STATE.md
docs/project-memory/DISCUSSION_SUMMARY.md
docs/project-memory/DECISIONS.md
docs/project-memory/RESEARCH.md
docs/project-memory/AI_AGENT_PROTOCOL.md
docs/project-memory/MILESTONES.md
...
Do not start unrelated work or the next milestone.

The overall workflow I recommend

STEP 1
Existing Mind Archive repository
        ↓
STEP 2
Claude audit
        ↓
...
You approve audit
        ↓
STEP 4
Claude implements Milestone 1
        ↓
STEP 5
Tests + Docker + Git verification
        ↓
STEP 6
Clean commit
        ↓
STEP 7
Measure your PC hardware
        ↓
STEP 8
Install Ollama
        ↓
STEP 9
Select appropriate local coding model
        ↓
STEP 10
Configure Qwen Code / OpenCode
        ↓
STEP 11
Use local AI for routine development
        ↓
STEP 12
Use Claude/Gemini/Cursor/etc. whenever
you want stronger reasoning or another opinion