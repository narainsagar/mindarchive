...
1. `project-memory/PROJECT_STATE.md` — what actually exists right now
2. `project-memory/MILESTONES.md` — what is in scope
3. `project-memory/DECISIONS.md` — what is already decided
